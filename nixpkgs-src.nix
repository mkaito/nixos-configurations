fetchTarball {
  ## 17.03
  # url = https://github.com/NixOS/nixpkgs/archive/78e9665b48ff45d3e29f45b3ebeb6fc6c6e19922.tar.gz;
  # sha256 = "09f50jaijvry9lrnx891qmcf92yb8qs64n1cvy0db2yjrmxsxyw8";

  ## 17.09
  # url = https://github.com/NixOS/nixpkgs/archive/e984f9e48e193f4b772565d930fc8631178ac9cc.tar.gz;
